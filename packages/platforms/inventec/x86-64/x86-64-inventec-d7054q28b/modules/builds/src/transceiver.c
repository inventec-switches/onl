...
struct eeprom_map_s eeprom_map_sfp = {
    ...
    .addr_eeprom       =0x50,  .page_eeprom       =-1,  .offset_eeprom       =128,  .length_eeprom       =128,
    .addr_uppage       =0x50,  .page_uppage       =-1,  .offset_uppage       =256,  .length_uppage       =128,
};
...
_common_update_attr_all(struct transvr_obj_s *self,
    ...
    if (_common_update_attr_eeprom(self, show_err) < 0) {
        err_str = "_sfp_update_attr_eeprom";
        goto err_common_update_attr_all;
    }
    if (_common_update_attr_uppage(self, show_err) < 0) {
        err_str = "_sfp_update_attr_uppage";
        goto err_common_update_attr_all;
    }
    return 0;
