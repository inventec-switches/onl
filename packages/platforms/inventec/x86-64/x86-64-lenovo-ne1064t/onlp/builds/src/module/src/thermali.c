...
static char* devfiles__[THERMAL_MAX] =  /* must map with onlp_thermal_id */
{
    ...
    INV_CPLD_PREFIX"/temp1_ne1064t_%s",
    INV_CPLD_PREFIX"/temp2_ne1064t_%s",
    INV_CPLD_PREFIX"/temp3_ne1064t_%s",
...
static onlp_thermal_info_t linfo[THERMAL_MAX] = {
	...
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_1_ON_SWITCH_BROAD), "NE1064T Thermal Sensor 1", 0},
	    ONLP_THERMAL_STATUS_PRESENT,
	    ONLP_THERMAL_CAPS_ALL, 0, ONLP_THERMAL_THRESHOLD_INIT_DEFAULTS
        },
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_2_ON_SWITCH_BROAD), "NE1064T Thermal Sensor 2", 0},
	    ONLP_THERMAL_STATUS_PRESENT,
	    ONLP_THERMAL_CAPS_ALL, 0, ONLP_THERMAL_THRESHOLD_INIT_DEFAULTS
        },
	{ { ONLP_THERMAL_ID_CREATE(THERMAL_3_ON_SWITCH_BROAD), "NE1064T Thermal Sensor 3", 0},
	    ONLP_THERMAL_STATUS_PRESENT,
	    ONLP_THERMAL_CAPS_ALL, 0, ONLP_THERMAL_THRESHOLD_INIT_DEFAULTS
	},
