...
#include "x86_64_lenovo_ne1064t_log.h"

#define ONLP_NODE_MAX_INT_LEN	(8)
#define ONLP_NODE_MAX_PATH_LEN	(64)

#define INV_CPLD_COUNT		(2)
#define INV_CPLD_PREFIX		"/sys/bus/i2c/devices/0-0077/"
#define INV_CPLD2_PREFIX	"/sys/bus/i2c/devices/0-0033/"
#define INV_EPRM_PREFIX		"/sys/bus/i2c/devices/0-0057/"
...
#define CHASSIS_10G_COUNT	(48)
#define CHASSIS_100G_COUNT	(6)
#define CHASSIS_SFP_START	(CHASSIS_10G_COUNT)
#define CHASSIS_SFP_COUNT	(CHASSIS_10G_COUNT+CHASSIS_100G_COUNT)
...
#define THERMAL_CPU_CORE_FIRST  THERMAL_CPU_CORE_0
#define THERMAL_CPU_CORE_LAST   THERMAL_CPU_CORE_0
...
#define PSU1_AC_PMBUS_PREFIX	INV_CPLD_PREFIX
#define PSU2_AC_PMBUS_PREFIX	INV_CPLD_PREFIX
 ...
 */
#define FAN_BOARD_PATH	INV_CPLD_PREFIX
