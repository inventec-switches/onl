 ...
 *
 * @file
 * @brief arm_inventec_d2428 Configuration Header
 *
 * @addtogroup arm_inventec_d2428-config
 * @{
 *
 *****************************************************************************/
...
#include <arm_inventec_d2428_custom_config.h>
#endif
...
typedef struct arm_inventec_d2428_config_settings_s {
    /** name */
    const char* name;
    /** value */
    const char* value;
} arm_inventec_d2428_config_settings_t;

/** Configuration settings table. */
/** arm_inventec_d2428_config_settings table. */
extern arm_inventec_d2428_config_settings_t arm_inventec_d2428_config_settings[];

/**
 * @brief Lookup a configuration setting.
 * @param setting The name of the configuration option to lookup.
 */
const char* arm_inventec_d2428_config_lookup(const char* setting);

/**
 * @brief Show the compile-time configuration.
 * @param pvs The output stream.
 */
int arm_inventec_d2428_config_show(struct aim_pvs_s* pvs);

/* <auto.end.cdefs(ONLPSIM_CONFIG_HEADER).header> */

#include "arm_inventec_d2428_porting.h"
