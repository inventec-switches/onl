...
class OnlPlatform_x86_64_inventec_magnolia_r0(OnlPlatformInventec,
                                              OnlPlatformPortConfig_32x100):
    PLATFORM='x86-64-inventec-magnolia-r0'
    MODEL="X86-MAGNOLIA"
    SYS_OBJECT_ID=".1.32"

    def baseconfig(self):
        os.system("insmod /lib/modules/`uname -r`/onl/inventec/x86-64-inventec-magnolia/gpio-ich.ko gpiobase=0")
