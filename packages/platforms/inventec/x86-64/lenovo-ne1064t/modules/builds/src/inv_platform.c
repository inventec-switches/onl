...
#if MODEL_SFP
static struct pca954x_platform_mode mux_modes_1_0[] = {
...
static struct pca954x_platform_mode mux_modes_1_1[] = {
...
static struct pca954x_platform_mode mux_modes_1_2[] = {
...
static struct pca954x_platform_mode mux_modes_1_3[] = {
...
static struct pca954x_platform_mode mux_modes_1_4[] = {
...
static struct pca954x_platform_mode mux_modes_1_5[] = {
...
static struct pca954x_platform_mode mux_modes_1_6[] = {
...
#if MODEL_SFP
static struct pca954x_platform_data mux_data_1_0 = {
        .modes          = mux_modes_1_0,
        .num_modes      = 8,
};
static struct pca954x_platform_data mux_data_1_1 = {
        .modes          = mux_modes_1_1,
        .num_modes      = 8,
};
static struct pca954x_platform_data mux_data_1_2 = {
        .modes          = mux_modes_1_2,
        .num_modes      = 8,
};
static struct pca954x_platform_data mux_data_1_3 = {
        .modes          = mux_modes_1_3,
        .num_modes      = 8,
};
static struct pca954x_platform_data mux_data_1_4 = {
        .modes          = mux_modes_1_4,
        .num_modes      = 8,
};
static struct pca954x_platform_data mux_data_1_5 = {
        .modes          = mux_modes_1_5,
        .num_modes      = 8,
};
static struct pca954x_platform_data mux_data_1_6 = {
        .modes          = mux_modes_1_6,
        .num_modes      = 8,
};
#endif
...
static struct i2c_board_info i2c_device_info11[] __initdata ={
        {"pmbus",            0, 0x58, 0, 0 ,0},		//PSU1 EVT
        {"pmbus",            0, 0x59, 0, 0 ,0},		//PSU2 EVT
...
static struct inv_i2c_board_info i2cdev_list[] = {
    ...
    {bus_id(8),  ARRAY_SIZE(i2c_device_info8),  i2c_device_info8 , 1},  //mux 0x70 channel 4
    {bus_id(9),  ARRAY_SIZE(i2c_device_info9),  i2c_device_info9 , 1},  //mux 0x70 channel 5
    {bus_id(10), ARRAY_SIZE(i2c_device_info10), i2c_device_info10, 1},  //mux 0x70 channel 6
#endif
};
