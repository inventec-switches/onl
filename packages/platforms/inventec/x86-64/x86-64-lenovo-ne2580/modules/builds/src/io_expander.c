 ...
 * Platform: Gulmohar, Peony_SFP1, Peony_Copper
 */
...
/* PortType: QSFP / 8 port
 * Platform: Peony_SFP2
 */
struct ioexp_map_s ioexp_map_8p_qsfp_type_1 = {
...
get_ioexp_map(int ioexp_type){
    switch (ioexp_type){
        ...
        case IOEXP_TYPE_QSFP_8P_LAYOUT_1:
            return &ioexp_map_8p_qsfp_type_1;
        default:
            return NULL;
    }
}
