...
class OnlPlatform_x86_64_inventec_d3352_r0(OnlPlatformInventec,
    ...
    def baseconfig(self):
        os.system("insmod /lib/modules/`uname -r`/onl/inventec/x86-64-inventec-d3352/gpio-ich.ko ")
        ...
        self.new_i2c_device('inv_psoc', 0x66, 10)
        self.new_i2c_device('inv_cpld', 0x55, 10)
        self.insmod('swps')
