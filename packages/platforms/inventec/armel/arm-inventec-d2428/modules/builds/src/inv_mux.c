...
cpld_rst_all_4_pull_low(struct mux_obj_s *self){
    ...
    switch(self->gpio_num) {
        ...
        case MUX_RST_CPLD_COTTONWOOD:
            goto setlow_cpld_rst_all_4_cott_lite;
...
setlow_cpld_rst_all_4_cott_lite:
    err = _setup_i2c_value(self, 0x29, 0x00);
    if (err < 0) {
        emsg = "setup 0x29 fail";
        goto err_cpld_rst_all_4_pull_low;
    }
    return 0;
...
cpld_rst_all_4_pull_high(struct mux_obj_s *self){
    ...
    switch(self->gpio_num) {
        ...
        case MUX_RST_CPLD_COTTONWOOD:
            goto sethigh_cpld_rst_all_4_cott_lite;
...
sethigh_cpld_rst_all_4_cott_lite:
    err = _setup_i2c_value(self, 0x29, 0x01);
    if (err < 0) {
        emsg = "setup 0x29 fail";
        goto err_cpld_rst_all_4_pull_high;
    }
...
init_cpld_4_rst_all(struct mux_obj_s *self){
    ...
    switch(self->gpio_num) {
        ...
        case MUX_RST_CPLD_COTTONWOOD:
            goto init_cpld_rst_all_4_cott_lite;
...
init_cpld_rst_all_4_cott_lite:
    ...
    SWPS_DEBUG("%s: init_cpld_rst_all_4_cott_lite ok", __func__);
    return 0;
